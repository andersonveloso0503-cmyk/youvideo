...
A oração precisa ter aproximadamente ${palavrasAlvo} palavras (pra durar bem perto de ${duracaoMin} minutos ao ser falada, em ritmo calmo).
...
- Estrutura sugerida: abertura (gratidão/entrega do dia), corpo (pedidos, força, proteção, paz — relacionados ao tema), fechamento (bênção, "em nome de Jesus, amém").
...
- Retorne APENAS um JSON válido, sem texto antes ou depois, no formato:
{
  ...
  "narracao": "texto completo da oração, em português, seguindo tudo acima",
