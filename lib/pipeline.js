...
// Sobe uma legenda .srt real (gerada a partir do timing de palavras que já
// temos) como faixa oficial do vídeo. Com uma faixa já existente, o YouTube
// para de rodar a própria legenda automática (pior e sujeita a duplicar
// visualmente com o texto que já queimamos no vídeo) por cima dela.
...
export async function publicarYoutubePrivado({ videoUrl, thumbnailUrl, titulo, descricao, tags, palavras }) {
