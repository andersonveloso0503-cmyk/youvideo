    ...
    bloco.forEach((palavraAtual, idx) => {
      ...
      legendaKaraoke.push({
        asset: {
          type: 'html',
          html: `<p>${html}</p>`,
          css: `p { font-family: 'Open Sans', sans-serif; font-size: ${isVertical ? 30 : 34}px; font-weight: 700; text-align: center; background: #000000; padding: 10px 18px; border-radius: 4px; margin: 0; }`,
