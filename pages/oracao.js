...
const TEMAS_SUGERIDOS = [
  ...
  'Provisão financeira e prosperidade',
  'Família unida e protegida',
  'Restauração do casamento',
  'Filhos sob a proteção de Deus',
  'Perdão e cura de mágoas',
  'Fé para vencer o medo',
  'Renovação das forças',
  'Favor e abertura de portas no trabalho',
  'Vitória sobre a depressão e o desânimo',
  'Confiança no tempo de Deus',
  'Libertação espiritual',
  'Novos começos e recomeços',
  'Paciência e domínio próprio',
  'Cura de relacionamentos',
  'Prosperidade nos negócios',
  'Descanso e sono tranquilo',
  'Coragem para tomar decisões difíceis',
  'Unção e capacitação para o dia a dia',
  'Quebra de maldição geracional',
  'Esperança em meio às provações',
  'Alegria e contentamento',
  'Sabedoria para criar os filhos',
];
